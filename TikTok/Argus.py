...
from TikTok.Sm3 import SM3
from TikTok.Simon import simon_enc
from TikTok.protobuf import ProtoBuf
...
class Argus:
    ...
    def get_sign(
        ...
        if params_dict.get("device_id"):
          device_id=params_dict["device_id"][0]
        else:
          device_id=""
